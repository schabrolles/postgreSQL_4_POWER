...
# Path to use 16MB hugespages on POWER
%ifarch ppc ppc64 ppc64le
Patch8:		hugepages-16M-ppc64.patch
%endif
...
%changelog
* Tue Aug 30 2016 Sebastien Chabrolles <s.chabrolles@fr.ibm.com> - 9.5.4.2PGDG.ibmmoppslc
- Change hugepage size to 16MB for POWER arch. 
